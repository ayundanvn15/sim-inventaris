          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Transaksi Keluar Sarana</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if($mulai!=null || $selesai!=null){
                      $query = mysqli_query($koneksi, "SELECT * FROM tb_keluarsarana
                      INNER JOIN tb_sarana ON tb_keluarsarana.id_sarana = tb_sarana.id_sarana WHERE tgl_keluar
                      BETWEEN '$mulai' and '$selesai' order by id_keluarsarana DESC;");

                    } else {
                        $query = mysqli_query($koneksi, "SELECT * FROM tb_keluarsarana
                        INNER JOIN tb_sarana ON tb_keluarsarana.id_sarana = tb_sarana.id_sarana");
                    }
                  ...
                  <tr>
                    ...
                    <td><?php echo $klr['nama_sarana'];?></td>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Data Keluar sarana</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form method="get" action="master/keluar_sarana/tambah_keluar.php">
              ...
              <div class="form-group">
                ...
                <select type="text" class="form-control" id="formGroupExampleInput" placeholder="Nama Barang" name="nama_sarana" required>>
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM tb_sarana");
                    ...
                    ?>
                  <option value="<?php echo $klr['id_sarana']; ?>"><?php echo $klr['nama_sarana']; ?></option>
...
<script>
  function hapus_keluar(data_id){
    //alert('ok');
    //window.location=("master/keluar_sarana/hapus_keluar.php?id_keluar="+data_id);
    Swal.fire({
